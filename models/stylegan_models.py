...
class Generator(nn.Module):
    def __init__(
        ...
        self.n_convs_in_hierarchy_old = 2
        ...
        self.num_layers_old = len(n_joints) * 2 - 1
        self.n_total_conv_layers = (self.n_hierarchy_levels - 1) * self.n_convs_in_hierarchy + 1
        assert self.num_layers_old == (self.n_hierarchy_levels - 1) * self.n_convs_in_hierarchy_old + 1
