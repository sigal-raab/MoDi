...
from t2m.common.skeleton import Skeleton
import numpy as np
import os
...
class Pos2HumnML:
    ...
    def __init__(self, data_dir) -> None: 
        ...
        example_data = np.load(os.path.join(data_dir, self.example_id + '.npy'))
        example_data = example_data.reshape(len(example_data), -1, 3)

        self.example_data = torch.from_numpy(example_data)
    ...
    def extract_features(self,positions, feet_thre, n_raw_offsets, kinematic_chain, face_joint_indx, fid_r, fid_l):
    ...
    def convert(self,positions, feet_thre=0.05):
