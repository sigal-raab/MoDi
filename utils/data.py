...
class Edge():
    ...
    edges_list = [
        # one bone for the full spine
        # [(0, 1), (0, 2), (0, 3), (0, 6), (3, 4), (3, 5)],
        # [(0, 1), (1, 2), (0, 3), (3, 4), (0, 5), (5, 6), (6, 7), (5, 8), (8, 9), (0, 10)],
    ...
    # one bone for the full spine
    # {(0, 1): [(0, 1), (1, 2)], (0, 2): [(0, 3), (3, 4)], (0, 3): [(0, 5)], (0, 6): [(0, 10)],
    #  (3, 4): [(5, 6), (6, 7)], (3, 5): [(5, 8), (8, 9)]},
    # {(0, 1): [(1, 2)], (1, 2): [(2, 3), (3, 4)], (0, 3): [(1, 5)], (3, 4): [(5, 6), (6, 7)],
    #  (0, 5): [(1, 8)], (5, 6): [(8, 9)], (6, 7): [(9, 10), (10, 11)],
    #  (5, 8): [(8, 12)], (8, 9): [(12, 13), (13, 14)], (0, 10): [(0, 1)]}]
    # 3 bones at spine
    {(0,1): [(1,3)]},
    {(1,3): [(3,7)], (0, 1): [(0, 1), (0, 2), (0, 3), (0, 6), (3, 4), (3, 5)]},
    ...
    # one bone for the full spine
    # {(0, 1): [(1, 2)], (0, 2): [(3, 4)], (0, 3): [(0, 5)], (0, 6): [(0, 10)],
    #  (3, 4): [(6, 7)], (3, 5): [(8, 9)]},
    # {(0, 1): [(1, 2)], (1, 2): [(3, 4)], (0, 3): [(1, 5)], (3, 4): [(6, 7)],
    #  (0, 5): [(1, 8)], (5, 6): [(8, 9)], (6, 7): [(10, 11)],
    ...
    # one bone for the full spine
    # parents_list_edges = [{(0, 1): (0, 3), (0, 2): (0, 3), (0, 3): -1, (0, 6): (0, 3), (3, 4): -1, (3, 5): -1},
    #                  {(0, 1): (0, 5), (1, 2): (0, 1), (0, 3): (0, 5), (3, 4): (0, 3), (0, 5): -1,
    #                   (5, 6): -1, (6, 7): (5, 6), (5, 8): -1, (8, 9): (5, 8), (0, 10): (0, 5)},
    #                  {(0, 1): (1, 8), (1,2): (1, 8), (2, 3): (1, 2), (3, 4): (2, 3), (1, 5): (1, 8), (5, 6): (1, 5),
    #                   (6, 7): (5, 6), (1, 8): -1, (8, 9): -1, (9, 10): (8, 9), (10, 11): (9, 10), (8, 12): -1,
    #                   (12, 13): (8, 12), (13, 14): (12, 13)}]
    # 3 bones at spine
