...
class OptimOptions(TestOptions):
    def __init__(self):
        super(OptimOptions, self).__init__()
        self.parser.add_argument(
            "--lr", default=0.1, type=float, help="learning rate"
        )
        self.parser.add_argument(
            "--target_idx", default=0, type=int
        )
        self.parser.add_argument(
            "--lambda_disc", default=0, type=float
        )
        self.parser.add_argument(
            "--lambda_latent_center", default=0, type=float
        )
        self.parser.add_argument(
            "--n_iters", default=5000, type=int
        )
        self.parser.add_argument(
            "--lambda_pos", default=3e-3, type=float
        )
        self.parser.add_argument(
            "--use_local_pos", default=1, type=int
        )
        self.parser.add_argument(
            "--Wplus", type=int, default=1,
...
class TrainOptions(BaseOptions):
    def __init__(self):
        ...
        parser.add_argument(
            "--g_foot_reg_weight", type=float, default=1, help="weight of the foot contact regularization"
        )
        parser.add_argument(
            "--g_encourage_contact_weight", type=float, default=0.01,
